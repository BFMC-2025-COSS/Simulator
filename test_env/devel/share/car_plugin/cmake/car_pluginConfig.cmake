...
if("TRUE" STREQUAL "TRUE")
  set(car_plugin_SOURCE_PREFIX /home/hanbin/Simulator/test_env/src/plugins_pkgs/car_plugin)
  set(car_plugin_DEVEL_PREFIX /home/hanbin/Simulator/test_env/devel)
  ...
  set(car_plugin_INSTALL_PREFIX /home/hanbin/Simulator/test_env/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'car_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hanbin/Simulator/test_env/src/plugins_pkgs/car_plugin/${idir}'.  ${_report}")
    endif()
